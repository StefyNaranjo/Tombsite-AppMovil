...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? IniciosesionWidget() : InicioWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'polyline',
          path: '/polyline',
          builder: (context, params) => PolylineScreen(
            nombre: params.getParam(
              'nombre',
              ParamType.DocumentReference,
             collectionNamePath: ['familiares'],
        ...
        FFRoute(
          name: 'addregistro',
          path: '/addregistro',
          builder: (context, params) => AddRegistroWidget(),
        ),
        FFRoute(
          name: 'version',
          path: '/version',
        ...
        FFRoute(
          name: 'reseteo',
          path: '/reseteo',
          builder: (context, params) => ReseteoWidget(),
        ),
